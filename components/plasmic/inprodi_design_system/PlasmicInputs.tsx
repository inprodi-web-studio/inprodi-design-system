...
import sty from "./PlasmicInputs.module.css"; // plasmic-import: CzasRJTWtOrr/css

createPlasmicElementProxy;

export type PlasmicInputs__VariantMembers = {};
export type PlasmicInputs__VariantsArgs = {};
type VariantPropType = keyof PlasmicInputs__VariantsArgs;
export const PlasmicInputs__VariantProps = new Array<VariantPropType>();

export type PlasmicInputs__ArgsType = {};
type ArgPropType = keyof PlasmicInputs__ArgsType;
export const PlasmicInputs__ArgProps = new Array<ArgPropType>();
...
function PlasmicInputs__RenderFunc(props: {
  variants: PlasmicInputs__VariantsArgs;
  args: PlasmicInputs__ArgsType;
  overrides: PlasmicInputs__OverridesType;
  forNode?: string;
}) {
  ...
  return (
    <React.Fragment>
      <Head>
        ...
        <title key="title">{PlasmicInputs.pageMetadata.title}</title>
        <meta
          key="og:title"
          property="og:title"
...
type NodeComponentProps<T extends NodeNameType> =
  ...
  } & Omit<PlasmicInputs__VariantsArgs, ReservedPropsType> & // Specify variants directly as props
    /* Specify args directly as props*/ Omit<
      PlasmicInputs__ArgsType,
      ReservedPropsType
    > &
